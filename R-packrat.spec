...
Version  : 0.4.9.1
Release  : 2
URL      : https://cran.r-project.org/src/contrib/packrat_0.4.9-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/packrat_0.4.9-1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521242091
