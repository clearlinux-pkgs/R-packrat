...
Version  : 0.9.3
Release  : 60
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/packrat_0.9.3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/packrat_0.9.3.tar.gz
...
%setup -q -n packrat
pushd ..
cp -a packrat buildavx2
popd
pushd ..
cp -a packrat buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750170920
...
/usr/lib64/R/library/packrat/vendor/renv.R
